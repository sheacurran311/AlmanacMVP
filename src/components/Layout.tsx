...
import { HomeIcon, UserGroupIcon, GiftIcon, MegaphoneIcon, ChartBarIcon, UserCircleIcon, CashIcon } from '@heroicons/react/24/outline';
...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const navigation: NavItem[] = [
    ...
    { name: 'Points Transactions', href: `/dashboard/${tenantId}/points-transactions`, icon: CashIcon },
